...
export const KIT_QT_INPUT_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => KitQtInputComponent),
  multi: true,
};

@Component({
  selector: 'kit-qt-input',
  templateUrl: './kit-qt-input.component.html',
  styleUrls: ['./kit-qt-input.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [KIT_QT_INPUT_VALUE_ACCESSOR],
})
export class KitQtInputComponent implements ControlValueAccessor, OnInit, OnChanges {
